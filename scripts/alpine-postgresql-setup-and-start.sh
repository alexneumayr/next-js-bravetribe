...
echo '["DATABASE_URL", "NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME", "NEXT_PUBLIC_CLOUDINARY_API_KEY", "CLOUDINARY_API_SECRET", "NEXT_PUBLIC_GOOGLE_MAPS_API_KEY", "NEXT_PUBLIC_MAP_ID", "NEXT_PUBLIC_KNOCK_API_KEY", "KNOCK_API_SECRET", "NEXT_PUBLIC_KNOCK_FEED_CHANNEL_ID"]'
